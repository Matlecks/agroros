...
<div class="container about_us_page">
	<div class="row">
		<div class="col-lg-12 about_us_text">
			<div class="text_big">
				<?php $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/about_us_text_big.php"), false);?>
			</div>
			<div class="text_small">
				<?php $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/about_us_text_small.php"), false);?>
			</div>			
		</div>
	</div>
	<div class="row double_text">
		<div class="col-lg-5 col-md-5 col-sm-9 col-xs-12 left">
			<?php $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/about_us_double_text_left.php"), false);?>
		</div>
		<div class="col-lg-7 col-md-7 col-sm-10 col-xs-12 right">
			<?php $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/about_us_double_text_right.php"), false);?>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 about_us_text company_prefix">
			<?php $APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/about_us_company_prefix.php"), false);?>
		</div>
	</div>
</div>
