...
if ($_SESSION['animal_filter']) {

    $allowed_sections = array();

    // Получаем список элементов
    $arSelect = array("IBLOCK_ID", "ID", "DETAIL_PAGE_URL", "IBLOCK_SECTION_ID");
    $arFilter = array("IBLOCK_ID" => $arParams["IBLOCK_ID"], "ACTIVE" => "Y", "PROPERTY_" . $_SESSION['animal_filter'] . "_VALUE" => 'Да');
...
<div class="sections_bottom_wrapper">

    <?if ($_SESSION['animal_filter'] && $_SESSION['animal_filter'] != 'all'):?>
        <div class="section_top_line <?=$_SESSION['animal_filter']?>">
            <div class="animals_left"></div>
            <div class="animals_right"></div>
        </div>
    <?endif;?>
    ...
    <div class="sections_bottom_back">
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                "BOTTOM_MODE" => 'Y',
                "ANIMAL_FILTER" => $_SESSION['animal_filter'],
        ...
        $solution_filter = array('PROPERTY_SOL_CATEGORY_VALUE' => $for_filter[$_SESSION['animal_filter']]);

        $APPLICATION->IncludeComponent(
            "bitrix:news.list",
            "solutions_list_section",
            array(
...
$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/catalog_animals_filter.php"), false);
?></div>